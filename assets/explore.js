...
const EXPLORE_AREAS = {
  en: [
    ...
    ['cognitive-health', 'Cognitive research'],
    ['physical-performance', 'Performance research'],
    ['healing-recovery', 'Regenerative research'],
    ['immune-support', 'Immune research'],
    ['skin-hair-aesthetics', 'Dermal research'],
    ['sleep-stress', 'Neuroendocrine research'],
    ['sexual-wellness', 'Melanocortin research'],
  ],
  es: [
    ['weight-loss', 'Investigación metabólica'],
    ['longevity', 'Investigación en longevidad'],
    ['cognitive-health', 'Investigación cognitiva'],
    ['physical-performance', 'Investigación en rendimiento'],
    ['healing-recovery', 'Investigación regenerativa'],
    ['immune-support', 'Investigación inmunológica'],
    ['skin-hair-aesthetics', 'Investigación dermatológica'],
    ['sleep-stress', 'Investigación neuroendocrina'],
    ['sexual-wellness', 'Investigación en melanocortinas'],
  ],
};
